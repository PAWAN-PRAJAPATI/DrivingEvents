...
export default class Location extends React.Component{
    ...
    updateMap=()=>{
      ...
      appDB.selectEvent(time1,time2,this.addPolyLines);
      }

    addPolyLines=(results)=>{
          var polylines = []
    ...
    componentDidMount(){
        ...
        var displaytime2 = dateString1.splice(1,2).join(' ')+"  "+ hour +':'+current_time.getMinutes()+ampm
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.mapLegend}>
        ...
        <Text style={{color:events_color["sharp_turn"],fontWeight: 'bold'}}>&#9632; Sharp Turn  </Text>
